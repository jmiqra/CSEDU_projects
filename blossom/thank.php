...
<body background = "image/thank.jpg">
<div class = "container">
        ...
        $pro_price = $row['price'];
            ...
            <div class='col-md-4'>
              ...
              <p><b>BDT $pro_price</b></p>
               ...
               <a href='thank.php?add_cart=$row[product_ID]'><img src='image/add.png' alt='add to cart''></a>
...
if ($con->connect_error) {
    die("Connection failed: " . $con->connect_error);
     ...
     $sql= "select * from products where keyword like '%thank%'";
     $result = mysqli_query($con, $sql);
