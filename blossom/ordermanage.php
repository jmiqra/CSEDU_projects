  ...
  <form action="" method="post" enctype="multipart/form-data">
            ...
            <table align="center" width="1000" bgcolor="AliceBlue">
                ...
                <tr height="50" align="center">
                    <td td colspan="4"><h2>Order List</h2></td>
                </tr>
    ...
    while($row = $result->fetch_assoc()) {
       ...
       $loc = "select * from ordertable where Order_ID = $order";

       $result1 = mysqli_query($con, $pro);

       $result3 = mysqli_query($con, $loc);
    ...
    <tr height="50" align="left">
      <td height="50"><input type ="checkbox" name="served[]" value=<?php echo $order;?>/></td>

     
     <td height="50"> <?php echo $order;?></td>
     <td height="50"> <?php echo $userid;?></td>

      <td height="50"><?php echo $pro_title;?><br>
        <img src="prod_image/<?php echo $pro_image;?>"width="60" height ="60"/></td>

      <td height="50"><?php echo $pro_qty;?></td>
       <td height="50"><?php echo $single;?><br></td>
      <td height="50"><?php echo $location;?></td>
    ...
    <tr height="90" align="center">
      <td height="90" colspan="2"><b><input type="submit" name="update" value="update" /></td>
  ...
  function update()
{
  ...
  if(isset($_POST['update']))
  {
    ...
    foreach($_POST['served'] as $serve_id)
    {
      ...
      $delete = "delete from ordererd where Order_ID='$serve_id'";

      $delete1 = "delete from ordertable where Order_ID='$serve_id'";
      ...
      {
        //echo "removed";
         echo "<script><window.open('ordermanage.php','_self)</script>"; 
       
        echo "<script><window.open('ordermanage.php')</script>";
