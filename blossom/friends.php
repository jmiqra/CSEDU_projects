...
if ($con->connect_error) {
    die("Connection failed: " . $con->connect_error);
     ...
     $sql= "select * from products where keyword like '%friends%'";
     $result = mysqli_query($con, $sql);
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $pro_price = $row['price'];
            ...
            <div class='col-md-4'>
              ...
              <a href='friends.php?add_cart=$row[product_ID]'><img src='image/add.png' alt='add to cart''></a>
